...
const services: Record<string, Service> = {
  ...
  "oven-cleaning": {
    ...
    intro:
      "Oven cleaning targets grease build-up and residue affecting presentation and inspection outcomes.",
    inclusions: [
      "Interior wipe-down",
      "Hob degrease",
      "Glass door clean"
  ...
  "office-cleaning": {
    ...
    intro:
      "Office cleaning focuses on professional presentation and hygiene standards for working environments.",
    inclusions: [
      "Desk surface wipe",
      "Floor vacuum",
      "Bin emptying",
  ...
  "after-party-cleaning": {
    ...
    intro:
      "After party cleaning addresses waste removal, surface wipe-down, and floor restoration.",
    inclusions: [
      "Surface wipe-down",
      "Floor vacuum and mop",
      "Bin removal"
  ...
  "appliances-cleaning": {
    ...
    intro:
      "Appliance cleaning focuses on kitchen and household units affecting inspection and presentation.",
    inclusions: [
      "Microwave wipe",
  ...
  "housekeeper-cleaner": {
    ...
    intro:
      "Domestic housekeeping provides structured maintenance cleaning for occupied properties.",
    inclusions: [
      "Surface wipe-down",
      "Bathroom clean",
      "Kitchen clean",
  ...
  "mattress-cleaning": {
    ...
    intro:
      "Mattress cleaning improves hygiene and presentation standards.",
    inclusions: [
      "Surface vacuum",
  ...
  "sofa-upholstery-cleaning": {
    ...
    intro:
      "Upholstery cleaning improves presentation and reduces surface build-up.",
    inclusions: [
      "Surface vacuum",
  ...
  "seniors-cleaning": {
    ...
    intro:
      "Seniors cleaning provides structured, respectful cleaning support tailored for elderly residents.",
    inclusions: [
      "Bathroom clean",
      "Kitchen clean",
      "Floor vacuum and mop"
